<template>
	<view class="register">
		<view class="content">
			...
			<!-- 主体 -->
			<view class="main">
				<lInput v-model="phoneData" type="text" maxlength="11" placeholder="手机号"></lInput>
				<lInput v-model="passData" type="password" maxlength="11" placeholder="登录密码" isShowPass></lInput>
			...
			<view class="footer">
				...
				<text>|</text>
				<navigator url="login" open-type="navigate">已有账号登录</navigator>
			</view>
		</view>
	</view>
</template>
