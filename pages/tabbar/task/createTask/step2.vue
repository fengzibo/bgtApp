	...
	<view class="steps-main">
		<form @submit="formSubmit">
			<view class="cu-form-group">
				...
				<input class="text-right" placeholder="请输入任务名称" name="input"   v-model="form_data.recruiting_name"/>
			</view>
			...
			<view class="cu-form-group">
				...
				<input class="text-right" placeholder="请输入工作地点" name="input" v-model="form_data.explain"/>
			</view>
			<view class="cu-form-group">
				<view class="title">招募有效期</view>
				<picker mode="date" v-model="form_data.start_time" start="2015-09-01" end="2020-09-01" @change="validDateChange">
					<view class="picker">{{ form_data.start_time }}</view>
				</picker>
			</view>
		</form>
